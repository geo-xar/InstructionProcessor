...
TEST_CASE("Process instructions - 1st part - 5th day - 3rd sample", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input);
    REQUIRE(modifiedInput.size());
    CHECK(modifiedInput[4] == 99);
}
...
TEST_CASE("Process instructions - 1st part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, 1);
...
TEST_CASE("Input equal to 8 - position mode - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, 8);
    REQUIRE(printedOut.size() == 1);
...
TEST_CASE("Input less than 8 - position mode - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, 2);
    REQUIRE(printedOut.size() == 1);
    CHECK(printedOut[0] == 1);
}
...
TEST_CASE("Input greater than 8 - position mode - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, 9);
    REQUIRE(printedOut.size() == 1);
    CHECK(printedOut[0] == 0);
}
...
TEST_CASE("Input not equal to 8 - immediate mode - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, 10);
    REQUIRE(printedOut.size() == 1);
    CHECK(printedOut[0] == 0);
}
...
TEST_CASE("Input less than 8 - immediate mode - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, 7);
    REQUIRE(printedOut.size() == 1);
    CHECK(printedOut[0] == 1);
}
...
TEST_CASE("Input equal to 0 - position mode - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, 0);
    REQUIRE(printedOut.size() == 1);
    CHECK(printedOut[0] == 0);
}
...
TEST_CASE("Input not equal to 0 - position mode - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, -5);
    REQUIRE(printedOut.size() == 1);
    CHECK(printedOut[0] == 1);
}
...
TEST_CASE("Input not equal to 0 - immediate mode - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<int32_t>(input, 250);
    REQUIRE(printedOut.size() == 1);
    CHECK(printedOut[0] == 1);
}
...
TEST_CASE("Input less than 8 - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<uint32_t>(input, 7);
    REQUIRE(printedOut.size() == 1);
...
TEST_CASE("Input equal to 8 - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<uint32_t>(input, 8);
    REQUIRE(printedOut.size() == 1);
...
TEST_CASE("Input greater than 8 - 2nd part - 5th day", "[OpCodeProcessor]")
{
    ...
    OpCodeProcessor opCodeProcessor;
    auto [modifiedInput, printedOut] = opCodeProcessor.ProcessInstructions<uint32_t>(input, 9);
    REQUIRE(printedOut.size() == 1);
