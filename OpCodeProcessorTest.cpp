...
TEST_CASE("Process instructions 1st part - basic instruction input", "[CodeAdventureDay5]")
{
    ...
    CodeAdventureDay5::ProcessInsructions<uint32_t>(input, 1);
    CHECK(input[4] == 99);
}

TEST_CASE("Process instructions 1st part - instruction input with negative value", "[CodeAdventureDay5]")
{
    std::vector<int32_t> input =
    {
        1101,100,-1,4,0
    ...
    CodeAdventureDay5::ProcessInsructions<int32_t>(input, 1);
    CHECK(input[4] == 99);
}

TEST_CASE("Input not equal to 8 - 2nd part - position mode", "[CodeAdventureDay5]")
{
    std::vector<int32_t> input =
    {
    ...
    auto result = CodeAdventureDay5::ProcessInsructions<int32_t>(input, 1);
    REQUIRE(result.size() == 1);
    CHECK(result[0] == 0);
}

TEST_CASE("Input equal to 8 - 2nd part - position mode", "[CodeAdventureDay5]")
{
    std::vector<int32_t> input =
    {
        3,9,8,9,10,9,4,9,99,-1,8
    ...
    auto result = CodeAdventureDay5::ProcessInsructions<int32_t>(input, 8);
    REQUIRE(result.size() == 1);
    CHECK(result[0] == 1);
}

TEST_CASE("Input less than 8 - 2nd part - position mode", "[CodeAdventureDay5]")
{
    std::vector<int32_t> input =
    {
...
TEST_CASE("Input not less than 8 - 2nd part - position mode", "[CodeAdventureDay5]")
{
    std::vector<int32_t> input =
    {
        3,9,7,9,10,9,4,9,99,-1,8
    ...
    auto result = CodeAdventureDay5::ProcessInsructions<int32_t>(input, 9);
    REQUIRE(result.size() == 1);
    CHECK(result[0] == 0);
}

TEST_CASE("Input not equal to 8 - 2nd part - immediate mode", "[CodeAdventureDay5]")
{
    std::vector<int32_t> input =
    {
...
TEST_CASE("Input equal to 8 - 2nd part - immediate mode", "[CodeAdventureDay5]")
{
    std::vector<int32_t> input =
    {
        3,3,1108,-1,8,3,4,3,99
...
TEST_CASE("Input less than 8 - 2nd part - immediate mode", "[CodeAdventureDay5]")
{
    std::vector<int32_t> input =
    {
...
//TEST_CASE("Input not less than 8 - 2nd part - immediate mode", "[CodeAdventureDay5]")
//{
//    std::vector<int32_t> input =
//    {
//        3,3,1107,-1,8,3,4,3,99
